...
public class CuentaTest {
	...
	public void CDP1() {
		...
		assertEquals(Main.encontrarCuenta(per), "No tenemos cuenta para ti, �est�s seguro que has metido bien tus datos?");
	...
	public void CDP3() {
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Vamos que t� puedes");
	...
	public void CDP4() {
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Comfort");
	...
	public void CDP5() {
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Independizate que va siendo hora");
	...
	public void CDP6() {
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Saltando del Nido");
	...
	public void CDP14() {
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Bienvenido a la Vida Adulta");
...
=======
		...
		assertEquals(Main.encontrarCuenta(per), "Cuenta Saltando del Nido");
>>>>>>> 4c36c23ee9a83f313754ac716673a4b553b52835
